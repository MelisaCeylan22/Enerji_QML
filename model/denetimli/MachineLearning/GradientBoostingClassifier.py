...
OUT_DIR = DATA_DIR / "ml_out" / "gradient_boosting"
...
# GradientBoosting baseline parametreleri
GB_PARAMS = dict(
    n_estimators=300,
    learning_rate=0.06,
    max_depth=3,          # ağaç derinliği (base estimator)
...
def main():
    ...
    # GradientBoostingClassifier class_weight desteklemez -> sample_weight kullan
    ...
    # GBC'de feature_importances_ var
