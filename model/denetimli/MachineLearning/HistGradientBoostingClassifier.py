...
OUT_DIR = DATA_DIR / "ml_out" / "hist_gradient_boosting"
...
# HGB baseline parametreleri (büyük veri için uygun)
HGB_PARAMS = dict(
    loss="log_loss",
    learning_rate=0.08,
    max_iter=400,            # iter sayısı (ağaç sayısı gibi düşün)
    max_leaf_nodes=31,
    min_samples_leaf=50,     # çok büyük veri için genelde iyi
    l2_regularization=0.0,
    early_stopping=False,    # time-series leakage riskini azaltmak için kapalı
    random_state=RANDOM_STATE,
    verbose=0,               # ilerleme görmek istersen 1 yap
)
...
def main():
    ...
    # class imbalance için sample_weight (sklearn sürüm bağımsız en sağlam yol)
    ...
    print("\n=== TEST RESULTS (HistGradientBoosting) ===")
    ...
    # Bazı sklearn sürümlerinde feature_importances_ yok; varsa kaydet
